 ...
 * FileName: CustomerDataCombiner.java
 * Author:   zhangdanji
 * Date:     2017年05月31日
 * Description: 用户上网数据combiner  
 */
package com.mychebao.hadoop.combiner;
 ...
 * @author zhangdanji
 */
public class CustomerDataCombiner extends Reducer<Text,CustomerWritable,Text,CustomerWritable> {
